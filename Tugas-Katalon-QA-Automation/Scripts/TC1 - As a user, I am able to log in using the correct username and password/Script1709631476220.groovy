...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_username'), GlobalVariable.username)

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_password'), GlobalVariable.password)
